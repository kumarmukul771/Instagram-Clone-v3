...
//    This method can be used to set static images. It cannot be used if the images are being changed
//    in the fragment/activity or if they are being set in a list or a grid
